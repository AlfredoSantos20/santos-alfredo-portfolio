    ...
    <div className='h-full bg-primary/30 py-32 text-center xl:text-left'>
        ...
        <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
          ...
          <div className='flex-1 flex flex-col justify-center'>
            ...
            initial='hidden'
            animate='show'
            exit='hidden' className='max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0'> 4 years ago, As a first-year college student I began freelancing as a developer  creating projects like case studies, websites, 
        ...
        <motion.div
         ...
         <div className='flex flex-1 xl:gap-x-6'>
              ...
              <div className='text-xs uppercase tracking-[1px] leadning-[1x4] max-w-[100px]'>  Years of experience </div>
            </div>
               {/* clients */}
            <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute 
                  after:top-0 after:right-0'>
              ...
              <div className='text-xs uppercase tracking-[1px] leadning-[1x4] max-w-[100px]'>  Satisfied Clients </div>
            </div>
              ...
              <div className='text-xs uppercase tracking-[1px] leadning-[1x4] max-w-[100px]'>  Finished projects</div>
            </div>
             ...
             <div className='relative flex-1'>
              ...
              <div className='text-xs uppercase tracking-[1px] leadning-[1x4] max-w-[100px]'>  Certificates </div>
            </div>
          </div>
        </motion.div>
      </div>

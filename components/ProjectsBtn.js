...
const ProjectsBtn = () => {
  ...
  <div className='mx-auto xl:mx-0'>
    <Link  title="Download Resume" target='_blank' href="/Alfredo B Santos Jr - resume.pdf" download className='relative w-[185px] h-[185px] flex justify-center items-center
